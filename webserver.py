...
function ariaText(k,txt){if(txt!==k)return txt;let m={cz:{pause:'Pozastavit',stop:'Zastavit',rewind10:'Zpět 10 sekund',forward10:'Vpřed 10 sekund',volumedown:'Snížit hlasitost',volumeup:'Zvýšit hlasitost',mute:'Ztlumit'
  "appsReturnDesc": "• <b>Ctrl+C</b> — ukončí většinu aplikací
• <b>Ctrl+Q</b> — ukončí Steam Link
• <b>tlačítko ZASTAVIT</b> — vynutí návrat
• Aplikace běží přímo na TV, dashboard se automaticky vrátí po ukončení",
  "ytAgeDesc": "Kontrola čerstvosti cookies bez vyzrazení hodnot. Použij, když age-restricted video nejde přehrát.",
  
    },en:{pause:'Pause',stop:'Stop',rewind10:'Rewind 10 seconds',forward10:'Forward 10 seconds',volumedown:'Volume down',volumeup:'Volume up',mute:'Mute'}};return (m[LANG]&&m[LANG][k])||((m.en&&m.en[k])||txt)}
