...
- [x] **Track: webui-czech-completion** — Add missing EN/CZ translations in WebUI | [Plan](./tracks/webui-czech-completion_20260613/plan.md)
...
- [x] **Track: android-share-app** — Android share-target app | [Plan](./tracks/android-share-app_20260613/plan.md)
- [x] **Track: smart-home-integrations** — Alexa, Google Home, Home Assistant integrations | [Plan](./tracks/smart-home-integrations_20260613/plan.md)
