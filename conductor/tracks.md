...
- [ ] **Track: lightweight-auth-boundaries_20260729** — Role-based access control with Basic/Expert/Admin tiers, session management, CSRF protection, and local CLI provisioning (depends: dashboard-security-cleanup_20260723; blocks: unified-ui-ux-refactor_20260728) | [Plan](./tracks/lightweight-auth-boundaries_20260729/plan.md)
