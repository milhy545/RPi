...
from .common import _run, _pactl_lines, BT_SOUNDBAR_SINK, BT_SOUNDBAR_MAC, BT_SOUNDBAR_NAME, HDMI_SINK, USB_ALEXA_SRC, DLNA_SINK_KEYWORDS, SILENT_WAV, AUDIO_STATE_CACHE_TTL, _audio_state_cache, _audio_state_lock
...
def _audio_state_uncached() -> Dict[str, Any]:
    ...
    state["keepalive"] = _keepalive_status()
    return state
