...
from .handlers import (
    ...
    handle_devices_legacy,
    handle_devices_bt_scan,
    handle_bt_scan,
    handle_bt_state,
    handle_bt_discovery,
    ...
    handle_cec_key,
    handle_cec_in,
    handle_cec_bridge_start,
    handle_cec_bridge_stop,
    handle_cec_bridge_status,
    handle_cec_power,
    handle_cec_nav,
    handle_cec_vol,
    handle_cec_input,
...
ROUTES: Dict[str, Callable] = {
    ...
    "/devices": handle_devices_legacy,
    "/devices/bt/scan": handle_devices_bt_scan,
    ...
    "/cec/send": handle_cec_send,
    "/cec/key": handle_cec_key,
    "/cec/in": handle_cec_in,
    "/cec/br/start": handle_cec_bridge_start,
    "/cec/br/stop": handle_cec_bridge_stop,
    "/cec/br/st": handle_cec_bridge_status,
    ...
    "/system/restart-mpv": handle_restart_mpv,
    "/system/restart-dashboard": handle_restart_dashboard,
    "/system/restart-rpi": handle_restart_rpi,
