...
def main() -> int:
    ...
    failures += check("Player has compact paste button but no manual preview button", "onclick=\"pasteClipboardUrl()\"" in html and "function pasteClipboardUrl" in html and "🖼 Preview" not in html)
