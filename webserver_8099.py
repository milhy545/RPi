...
<div id="topbar"><h1 id="app-title">RPi-TV</h1><div id="lang-switch"><button class="lang-btn" data-lang-btn="en" onclick="setLang('en')" title="English" aria-label="English">🇬🇧</button><button class="lang-btn" data-lang-btn="cz" onclick="setLang('cz')" title="Čeština" aria-label="Čeština">🇨🇿</button></div></div><div id="security-banner"></div><div id="toast"></div>
<div class="tabs">
